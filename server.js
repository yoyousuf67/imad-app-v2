...
app.post('/create-user',function(req,res){
    ...
    pool.query('INSERT INTO "user" (username,password) VALUES ($1, $2),INSERT INTO "details" (name,dob,gender,username) VALUES ($3,$4,$5,$1)', [username,dbString,name,dob,gender],function(err,result){
        if (err){
