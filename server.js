...
app.post('/create-user',function(req,res){
    ...
    pool.query('INSERT INTO "user" (username,password) VALUES ($1,$2); INSERT INTO "details" (username,name,dob,gender) VALUES ($1,$2,$3,$4)',[username,password],[username,name,dob,gender],function(err,result){
        if (err){
